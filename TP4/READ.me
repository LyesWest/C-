...
ctype.hContient des fonctions pour manipuler les caractères, comme isdigit() pour tester si un caractère est un chiffre.

string.hContient des fonctions pour manipuler les chaînes de caractères, comme strcpy(), strstr(), strlen(), etc.

stdlib.hUtilisé pour la conversion de chaînes en nombre avec atof(), ainsi que pour la gestion de la mémoire dynamique.
